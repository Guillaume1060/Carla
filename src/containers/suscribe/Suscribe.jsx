...
import classes from './suscribe.module.scss'
        ...
        <ArrowUpIcon/>
            <div className={classes.footer}>
                ...
                <form onSubmit={handleSubmit}>
                    <input className={classes.footer_below_input} id="email" name="email" type={email} value={email} onChange={handleEmailChange} placeholder="GOT EMAIL?"/>
